    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="{{route('admin.home')}}" aria-expanded="false" aria-controls="sidebarDashboards" class="side-nav-link">
...
{{--                    <span class="badge bg-success float-end">5</span>--}}
            ...
            @endphp
            <li class="side-nav-item">
                <a href="{{route('all_in_one')}}" class="side-nav-link">
                    <i class="uil-comments-alt"></i>
                    <span class="badge bg-success float-end">{{$asset->where('type','all_in_one')->count()}}</span>
                    <span> All in One </span>
                </a>
            </li>
            <li class="side-nav-item">
                <a href="{{route('systems')}}" class="side-nav-link">
                    <i class="uil-comments-alt"></i>
                    <span class="badge bg-success float-end">{{$asset->where('type','pc')->count()}}</span>
                    <span> Systems </span>
                </a>
            </li>
            <li class="side-nav-item">
                <a href="{{route('laptop')}}" class="side-nav-link">
                    <i class="uil-comments-alt"></i>
                    <span class="badge bg-success float-end">{{$asset->where('type','laptop')->count()}}</span>
                    <span> Laptop </span>
                </a>
            </li>
            <li class="side-nav-item">
                <a href="{{route('printers')}}" class="side-nav-link">
                    <i class="uil-comments-alt"></i>
                    <span> Printers </span>
                </a>
            </li>
